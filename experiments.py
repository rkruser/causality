...
#	exp3struct = extractStats(exp3)
	plotRepresentatives(exp1struct, "exp1_rerun_n=10000")
#	plotRepresentatives(exp2struct, "exp2_delt=0.75")
#	plotRepresentatives(exp3struct, "exp3_delt=1.5_n=30000")
	printStatistics(exp1struct, "exp1_rerun_n=10000")
#	printStatistics(exp2struct, "exp2_delt=0.75")
#	printStatistics(exp3struct, "exp3_delt=1.5_n=30000")
